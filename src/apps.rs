...
pub const APPS: &[App] = &[
    ...
    App { name: "folio", bin: "folio", repo: "folio", kind: "PDF reader", blurb: "Read a PDF as text, as pages, or both at once", group: "Daily drivers" },
    ...
    App { name: "gaze", bin: "gaze", repo: "gaze", kind: "Web browser", blurb: "Looking out onto the web: WebKitGTK with vim keys, tab groups and saved logins", group: "Daily drivers" },
    App { name: "hush", bin: "hush", repo: "hush", kind: "Voice and video call", blurb: "A call that sends nothing while you are quiet", group: "Daily drivers" },
    ...
    App { name: "fleet", bin: "fleet", repo: "fleet", kind: "Claude Code Mission Control", blurb: "Every Claude session, its state and your inbox, one screen", group: "Desk" },
    App { name: "hl2web", bin: "hl2web", repo: "hl2web", kind: "HyperList Web Renderer", blurb: "A HyperList as one interactive HTML page", group: "Desk" },
    App { name: "hypergraph", bin: "hypergraph", repo: "hypergraph", kind: "HyperList Grapher", blurb: "Turns a HyperList into a graph you can actually read", group: "Desk" },
    App { name: "beam", bin: "beam", repo: "beam", kind: "Presentation Remote", blurb: "Pick what the room sees on the external screen", group: "Desk" },
    App { name: "yank", bin: "yank", repo: "yank", kind: "Clipboard history", blurb: "copy once, paste where you were", group: "Desk" },
    ...
    App { name: "moon", bin: "moon", repo: "moon", kind: "The Moon tonight", blurb: "The near side lit for tonight's phase, with the days around it", group: "Science" },
    ...
    App { name: "exoplanets", bin: "exoplanets", repo: "exoplanets", kind: "The Known Worlds", blurb: "6,309 planets by orbit and size, with their systems", group: "Science" },
    ...
    App { name: "isotopes", bin: "isotopes", repo: "isotopes", kind: "Chart of the Nuclides", blurb: "3,386 isotopes, how they decay and what into", group: "Science" },
    ...
    App { name: "circuit", bin: "circuit", repo: "circuit", kind: "Electronics Bench", blurb: "Wire up parts, power on and watch them work", group: "Science" },
    ...
    App { name: "alchemy", bin: "alchemy", repo: "alchemy", kind: "Chemistry bench", blurb: "pour reagents together and watch what happens", group: "Science" },
    App { name: "universe", bin: "universe", repo: "universe", kind: "scale explorer", blurb: "Every scale of the universe, from the quantum foam to the cosmic web", group: "Science" },
    ...
    App { name: "gambit", bin: "gambit", repo: "gambit", kind: "Chess", blurb: "Chess against a language model", group: "Play" },
    App { name: "funkey", bin: "funkeys", repo: "funkey", kind: "Games", blurb: "Doom, Space Invaders, Jumpman and more; Enter picks one", group: "Play" },
...
pub const LOGOS: &[(&str, &[u8])] = &[
    ...
    ("isotopes", include_bytes!("../img/logos/isotopes.png")),
    ("exoplanets", include_bytes!("../img/logos/exoplanets.png")),
    ("fractal", include_bytes!("../img/logos/fractal.png")),
    ("fleet", include_bytes!("../img/logos/fleet.png")),
    ("hl2web", include_bytes!("../img/logos/hl2web.png")),
    ("hypergraph", include_bytes!("../img/logos/hypergraph.png")),
    ("beam", include_bytes!("../img/logos/beam.png")),
    ("folio", include_bytes!("../img/logos/folio.png")),
    ("yank", include_bytes!("../img/logos/yank.png")),
    ("moon", include_bytes!("../img/logos/moon.png")),
    ("circuit", include_bytes!("../img/logos/circuit.png")),
    ("gambit", include_bytes!("../img/logos/gambit.png")),
    ("funkey", include_bytes!("../img/logos/funkey.png")),
    ("alchemy", include_bytes!("../img/logos/alchemy.png")),
    ...
    ("launch", include_bytes!("../img/logos/launch.png")),
    ("herald", include_bytes!("../img/logos/herald.png")),
