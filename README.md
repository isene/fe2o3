...
| [funkey](https://github.com/isene/funkey) | ![funkey](https://badgen.net/github/release/isene/funkey) | Game engine for the terminal: a pixel frame shown two pixels a cell or as real pixels, held keys, a fixed-step loop, sprites, tiles, platformer physics, sound, a 3D rasterizer and a Doom renderer; `climb`, `jumpman`, `drive` and the full `doom` run on it | — |
