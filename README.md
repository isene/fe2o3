...
| [moon](https://github.com/isene/moon) | ![moon](https://badgen.net/github/release/isene/moon) | The Moon as it looks tonight (near side from NASA's LRO map, lit for the phase, a strip of the days around it, and a zoomable braille map with the features named) | — |
